...
default_text = \
    "Hello, " \
    "We are Robotics Society from National institute of technology hamirpur!\n" \
    "Welcome to our project Deepfake\n" \
    "this produced output is not the original voice\n" \
    "It is used for demonstration purpose only" \
    ...
    def draw_umap_projections(self, utterances: Set[Utterance]):
        ...
        # Compute the projections
            ...
            for projection, utterance in zip(projections, utterances):
                ...
                mark = "x" if "gen" in utterance.name else "o"
